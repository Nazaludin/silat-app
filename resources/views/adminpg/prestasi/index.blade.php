<x-app-layout>
                        ...
                        <div class="-m-1.5 overflow-x-auto">
                            <div class="p-1.5 min-w-full inline-block align-middle">
                                <div class="border rounded-lg divide-y divide-gray-200">
                                    ...
                                    <div class="btn-main" data-hs-overlay="#modal-view-prestasi">
                                        Trigger Dummy
                                    </div>
                                </div>
                                    ...
                                    $(document).ready(function() {
                                        ...
                                        function fillTable(data) {
                                            ...
                                            $.each(data.data, function(index, item) {
                                                ...
                                                var tdDescription = $('<td>').addClass('px-6 py-4 text-sm text-gray-800 text-justify border-r border-r-gray-200 ').html('<div class="line-clamp-3">' + item.deskripsi + '</div>');
    ...
    <!-- modal -->
    <!-- modal -->
    <div id="modal-view-prestasi" class="hs-overlay hidden size-full fixed top-0 start-0 z-[999999] overflow-x-hidden overflow-y-auto pointer-events-none [--overlay-backdrop:static]" data-hs-overlay-keyboard="false">
        <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all w-full sm:max-w-[70rem] sm:w-full m-3 sm:mx-auto h-[calc(100%-3.5rem)] flex items-center justify-center">
            <div class="max-h-full overflow-hidden flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
                <div class="flex justify-between items-center py-3 px-4 border-b">
                    <div class="form-label"> Judul Prestasi</div>

                    <button type="button" class=" group flex justify-center items-center size-7 text-sm font-semibold rounded-full border border-main text-gray-800 hover:bg-main disabled:opacity-50 disabled:pointer-events-none transition duration-200 ease-in-out" data-hs-overlay="#modal-view-prestasi">
                        <span class="sr-only">Close</span>
                        <svg class="flex-shrink-0 size-4 group-hover:text-white transition duration-200 ease-in-out" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M18 6 6 18"></path>
                            <path d="m6 6 12 12"></path>
                ...
                <div class="p-4 overflow-y-auto">
                    <div class="space-y-4">
                        ...
                        <div class="flex flex-col justify-center items-center">
                            ...
                            <div class="form-label text-center"> Judul Prestasi</div>
