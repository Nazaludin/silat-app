        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900">
                    <form id="form_store_tokoh" action="{{ route('adminpg.tokoh.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="p-4 overflow-y-auto">
                            <div class="space-y-4">
                                <div class="form-group">
                                    ...
                                    <input placeholder="Nama tokoh..." id="namatokoh" name="nama" class="form-default" type="text" value="{{old('nama')}}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="relative mb-4" data-hs-combo-box="">
                                        <div class="relative">
                                            <input placeholder="Tipe..." id="tipe" name="tipe" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 disabled:opacity-50 disabled:pointer-events-none" type="text" value="{{old('tipe')}}" data-hs-combo-box-input="" />
                                        ...
                                        <div class="absolute z-50 w-full max-h-72 p-1 bg-white border border-gray-200 rounded-lg overflow-hidden overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500" style="display: none" data-hs-combo-box-output="">
                                            ...
                                            <div class="cursor-pointer py-2 px-4 w-full text-sm text-main hover:text-white hover:bg-main rounded-lg focus:outline-none focus:opacity-75" tabindex="0" data-hs-combo-box-output-item="">
                                                <div class="flex justify-between items-center w-full">
                                                    <span data-hs-combo-box-search-text="Guru Besar" data-hs-combo-box-value="">Guru Besar</span>
                                            ...
                                            <div class="cursor-pointer py-2 px-4 w-full text-sm text-main hover:text-white hover:bg-main rounded-lg focus:outline-none focus:opacity-75" tabindex="0" data-hs-combo-box-output-item="">
                                                <div class="flex justify-between items-center w-full">
                                                    <span data-hs-combo-box-search-text="Guru" data-hs-combo-box-value="">Guru</span>
                                                    <span class="hidden hs-combo-box-selected:block">
                                                        <svg class="flex-shrink-0 size-3.5 text-blue-600 dark:text-blue-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                            <path d="M20 6 9 17l-5-5"></path>
                                                        </svg>
                                            ...
                                            <div class="cursor-pointer py-2 px-4 w-full text-sm text-main hover:text-white hover:bg-main rounded-lg focus:outline-none focus:opacity-75" tabindex="0" data-hs-combo-box-output-item="">
                                                <div class="flex justify-between items-center w-full">
                                                    <span data-hs-combo-box-search-text="Tokoh Lainnya" data-hs-combo-box-value="">Tokoh Lainnya</span>
                                                    <span class="hidden hs-combo-box-selected:block">
                                                        <svg class="flex-shrink-0 size-3.5 text-blue-600 dark:text-blue-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                            <path d="M20 6 9 17l-5-5"></path>
                                                        </svg>
                                ...
                                <div class="w-full  mb-2 form-default border-[1px]">
                                    <label class="block">
                                        ...
                                        <input id="file" type="file" name="file" value="{{old('file')}}" class="block w-full text-sm text-gray-500
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Deskripsi..." id="deskripsitokoh" name="deskripsi" class="form-default" type="text">{{old('deskripsi')}}</textarea>
