        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900">
                    <form id="form_update_berita" action="{{ route('adminpg.berita.update',$berita->id_berita) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="judul" class="form-label">Judul</label>
                            <input placeholder="Judul..." id="judul" name="judul" class="form-default" type="text" value="{{ old('judul') ? old('judul') : $berita->judul }}" data-hs-combo-box-input="" />
                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                ...
                                <textarea id="berita" class="tinyMce" name="berita">{{ old('berita') ? old('berita') : $berita->berita }}</textarea>
