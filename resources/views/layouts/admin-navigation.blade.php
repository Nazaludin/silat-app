<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('adminpg.perguruan.index')" :active="request()->routeIs('adminpg.perguruan.*')">
                {{ __('Dashboard') }}
            </x-responsive-nav-link>
            <!-- <x-responsive-nav-link :href="route('adminpg.sejarah.index')" :active="request()->routeIs('adminpg.sejarah.*')">
                {{ __('Sejarah') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('adminpg.tokoh.index')" :active="request()->routeIs('adminpg.tokoh.*')">
                {{ __('Tokoh') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('adminpg.prestasi.index')" :active="request()->routeIs('adminpg.prestasi.*')">
                {{ __('Prestasi') }}
            </x-responsive-nav-link> -->
        </div>
